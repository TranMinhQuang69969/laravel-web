            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="card" style="border-radius: 15px;">
                    ...
                    @endif
                        ...
                        <input type="text" id="form3Example1cg" class="form-control form-control-lg" name="ten" value="{{ old('ten') }}"/>
                        @error('ten')
                        ...
                        <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="sdt" value="{{ old('sdt') }}"/>
                        @error('sdt')
                            <span class=" "style="color: red">{{ $message }}</span>
                        @enderror
                        </div>
                        ...
                        <input type="password" id="form3Example4cdg" class="form-control form-control-lg" name="confirmpass"/>
                        @error('confirmpass')
                            <span class=" "style="color: red">{{ $message }}</span>
                        @enderror
                        </div>

                        <p class="text-center text-muted  mb-0">Bạn đã có tài khoản? <a href="./login.php"
                            class="fw-bold text-body"><u>Đăng nhập</u></a></p>

                        <div class="d-flex justify-content-center mt-3">
                        <input type="submit"
                            class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" value="Đăng kí" >
                        </div>
